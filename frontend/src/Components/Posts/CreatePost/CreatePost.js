...
import blogwrittingimg from '../../../assets/blogwritings.png'
    ...
    render() {
        ...
        return (<>
            ...
            <div className="container container-short">
                ...
                <img src={blogwrittingimg} className="img-fluid mx-auto d-block max-width: 5% max-height: 5%" alt="img" />
                <div></div>
                <h3 className="text-center mt-3">Create Post</h3>
                <h5 className="text-center mt-3">Write your thoughts! Share your colours!</h5>
