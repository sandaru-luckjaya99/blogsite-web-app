...
import profile from '../../../assets/createprof.png';
    ...
    render() {
        ...
        return (<>
            ...
            <div className="container container-short">
                <img src={profile} className="img-fluid mx-auto d-block max-width: 5% max-height: 5%" alt="img" />
                <form onSubmit={this.mySubmitHandler} className="pt-4">
                    
                    <h3 className="text-center mb-3">Create Your Profile</h3>
                    <h6 className="text-center mb-3">Its time to create a profile to you</h6>
                    ...
                    <div className="form-group">
                        <label htmlFor="password"> About you </label>
                    ...
                    <div className="form-group">
                        <button style={{ background:'#123597', shadow: '0, 2px, 6px, rgba(0, 0, 0, 0.26)',color:'#FAFAFA', marginRight: '15px' }}
                            type='submit'
