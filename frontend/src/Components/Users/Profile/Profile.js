    ...
    render() {
        ...
        return (
            <>
                {isLoading}
                {iserror}
                <div className="container row-20 py-15 container-long">
                    <div className="row profile">

                        <div className="row profile">
                            <div className="col-md-6 col-xs-12 order-2 order-lg-2">
                                <h2 className="text-black font-weight-normal mb-4">{profile.username}</h2>
                                {(!storedData && path !== "/profile") ? null : <Link to={"/profile/edit/" + profile._id}  >Edit Profile</Link>}
                                <p className='font-weight-light row-by-row'>{profile.bio}</p>
                            </div>

                            <div className="col-md-4 col-xs-12 order-1 order-lg-1">
                                <img className="img-fluid w-62 rounded-circle mb-3"
                                    src={profile.imagePath} alt={profile.username}></img>
                            </div>
                        </div>

                        {/* <div className="col-md-4 col-xs-10 order-2 order-lg-1">
                            <img className="img-fluid w-50 rounded-circle mb-3"
                                src={profile.imagePath} alt={profile.username}></img>
                        </div>

                        <div className="col-md-8 col-xs-11 order-1 order-lg-2">
                ...
                <div className="container py-5 container-long">
